<template>
    <div class="flex justify-center">
        <div class="mt-[10rem] p-6 rounded-xl bg-white w-[417px] h-auto shadow-md">
            <form @submit.prevent="postEmail" class="vld-parent">
                <h1 class="text-center font-bold text-xl capitalize mb-4">lupa password</h1>
                <div class="mt-2">
